...
from clusgym_clus_move_com_ver5_mod6_expt2  import MCSEnv
import gym.wrappers
import numpy as np
import tensorforce 
...
eleNums = [20]
clus_seed = 100
save_dir = './result_multi_env_parallel_ver5_mod6_expt2_repeat/'
...
runner.run(num_episodes=32000,  callback=callback, callback_episode_frequency=1)
